...
import { createVoc } from "../../../actions/actionsFaculty";
...
export default function AddEducationVoc(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    setOpen(false);
    edu.vemailConn = userE?.result.email
    dispatch(createVoc(edu));
    console.log(edu.vemailConn);
            ...
            <Stack direction="column" spacing={3} justifyContent="center">
              ...
              >
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  name="vperiodOfAttendancetypefrom"
                  type="date"
                  variant="outlined"
                  sx={shortInputStyle}
                />
                ...
                <TextField
                  ...
                  type="date"
                  onChange={handleChange}
                  name="vperiodOfAttendancetypeto"
                  variant="outlined"
                  sx={shortInputStyle}
                />
              ...
              <TextField
                ...
                variant="outlined"
                onChange={handleChange}
                name="vscholarshipAcademicHonors"
